...
/** @brief Configure DECT Band 1 */
#define APP_LIB_DECT_BAND_1  (1UL<<1)
/** @brief Configure DECT Band 2 */
#define APP_LIB_DECT_BAND_2  (1UL<<2)
/** @brief Configure DECT Band 4 */
#define APP_LIB_DECT_BAND_4  (1UL<<4)
/** @brief Configure DECT Band 9 */
#define APP_LIB_DECT_BAND_9  (1UL<<9)
...
/**
 * @brief   Setup radio band configuration, relevant only for DECT platforms.
 * @param   band_mask
 *          bitmask of enabled DECT band. Bit position corresponds to enabled band.
 *          
 * @return  Result code, @ref APP_RES_OK if successful
 */
...
typedef struct
{
    ...
    /** Setup radio band configuration, works only when called at boot from App_init()
     *  Only 1 band may be selected at the time. APP_LIB_DECT_BAND_4 is not available on
     *  all platforms.
     */
