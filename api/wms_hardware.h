 ...
 * precision.
 *
 * Library services are accessed  via [lib_hw](@ref app_lib_hardware_t)
 * handle.
 */
 ...
 *
 * To be used with services [lib_hw->activatePeripheral()](@ref app_lib_hardware_activate_peripheral_f) and @ref
