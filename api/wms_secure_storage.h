 ...
 * 32-bit tags. They can be read, written, or deleted.
 *
 * Applications should only read from and write to their own predefined
 * persistent area. However, for special purposes, multiple areas may be used.
 *
 * Library services are accessed via \ref app_lib_secure_storage_t
 * "lib_secure_storage" handle.
 */
