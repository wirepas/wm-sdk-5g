 ...
 *
 * Library services are accesses via [lib_otap](@ref app_lib_otap_t) handle
 */
 ...
 *
 * Used with the
 * [lib_otap->getType()](@ref app_lib_otap_get_type_f) function
 */
typedef enum
{
 ...
 *
 * Used with the [lib_otap->getStatus()](@ref app_lib_otap_get_status_f) function
 *
 ...
 *
 * Used with the [lib_otap->write()](@ref app_lib_otap_write_f) function
 */
typedef enum
{
    /** Write succeeded */
 ...
 *
 * Used with the [lib_otap->setTargetScratchpadAndAction()](@ref app_lib_otap_set_target_scratchpad_and_action_f) function
 */
typedef enum
{
 ...
 * functions [lib_otap->getType()](@ref app_lib_otap_get_type_f) and
 * [lib_otap->getStatus()](@ref app_lib_otap_get_status_f).
 *
 ...
 * app_lib_otap_begin_f "lib_otap->begin()" / [lib_otap->write()](@ref app_lib_otap_write_f) cycle must not be
 ...
 *
 * When writing the scratchpad to a node, with the [lib_otap->write()](@ref app_lib_otap_write_f)
 ...
 *
 * Write must have been started with the [lib_otap->begin()](@ref app_lib_otap_begin_f) function.
 *
