 ...
 * platform.
 *
 * Library services are accessed via [lib_time](@ref app_lib_time_t)
 * handle.
 */
 ...
 * arithmetic ([lib_time->addUsToHpTimestamp()](@ref app_lib_time_add_us_to_timestamp_hp_f)
 * and [lib_time->getTimeDiffUs()](@ref app_lib_time_get_time_difference_us_f))
 * and comparisons ([lib_time->isHpTimestampBefore()](@ref app_lib_time_is_timestamp_hp_before_f))
 ...
 * comparisons functions [lib_time->isHpTimestampBefore()](@ref app_lib_time_is_timestamp_hp_before_f) and [lib_time->getTimeDiffUs()](@ref app_lib_time_get_time_difference_us_f).
 *
