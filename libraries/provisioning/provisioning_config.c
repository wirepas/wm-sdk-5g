...
static void populate_provisioning_settings(
...
static uint8_t write_provisioning_config(app_lib_settings_remote_api_csap_data_t * data)
{
    ...
    // Validate settings
    provisioning_settings_t settings;
    populate_provisioning_settings(temp_config, &settings);
    settings_validation_ret_e validation_result = validate_settings(&settings);
