...
#if defined(MAC_PROFILE_DECTNR)

/* Wirepas Provisioning Protocol endpoints for 5GMesh
 *
 *  - Downlink: Source: 0xA0 ; Destination: 0x28
 *  - Uplink: Source: 0xA0 ; Destination: 0x27
 */
/** Provisioning downlink endpoint. */
#define PROV_DOWNLINK_SRC_EP    0xA0
#define PROV_DOWNLINK_DST_EP    0x28
/** Provisioning uplink endpoint. */
#define PROV_UPLINK_SRC_EP      0xA0
#define PROV_UPLINK_DST_EP      0x27
#endif
 ...
 */
#define JOINING_RX_TIMEOUT      2100
#endif

#if defined(MAC_PROFILE_DECTNR)
/** \brief Time Interval to send joining beacons, in milliseconds */
#define JOINING_TX_INTERVAL     2000
#endif
 ...
 */
#if defined(MAC_PROFILE_DECTNR)
// For 5G Mesh the beacon type equals the provisioning data EP
#define JOINING_BEACON_TYPE 0xA027
#endif
