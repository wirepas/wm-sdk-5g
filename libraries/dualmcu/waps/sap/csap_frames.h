...
// structure to hold CSAP_ATTR_NETWORK_KEY_PAIR and CSAP_ATTR_MANAGEMENT_KEY_PAIR
...
typedef enum
{
    ...
    /* Write only */
    /* Internal CSAP attributes, reserved for Wirepas internal use only */
