 ...
 * \param   flow_ctrl
 *          Is flow control to be used or not. Note that flow control is
 *          only for application processor to hold communication. The mesh
 *          communication processor is designed to be able to receive full
 *          SLIP frame without holding transfer using HW flow control.
 * \param   tx_buffer
