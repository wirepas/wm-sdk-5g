...
- [Stack Service Specification](#stack-service-specification)
  ...
  * [Management Services (MSAP)](#management-services-msap)
    ...
    + [MSAP-CONFIG_DATA_ITEM Service](#msap-config-data-item-service)
...
|         | MSAP-CONFIG_DATA_ITEM_SET.request  | 0x29             |
|         | MSAP-CONFIG_DATA_ITEM_SET.confirm  | 0xA9             |
|         | MSAP-CONFIG_DATA_ITEM_GET.request  | 0x30             |
|         | MSAP-CONFIG_DATA_ITEM_GET.confirm  | 0xB0             |
|         | MSAP-CONFIG_DATA_ITEM.indication   | 0x31             |
|         | MSAP-CONFIG_DATA_ITEM.response     | 0xB1             |
|         | MSAP-CONFIG_DATA_ITEM_LIST_ITEMS.request | 0x32       |
|         | MSAP-CONFIG_DATA_ITEM_LIST_ITEMS.confirm | 0xB2       |
...
**Note 4:** The MSAP-APP_CONFIG_DATA_WRITE service will be deprecated in a future
release. Use MSAP-CONFIG_DATA_ITEM_SET service instead.
...
**Note 1:** The MSAP-APP_CONFIG_DATA_READ service will be deprecated in a future
release. Use MSAP-CONFIG_DATA_ITEM_GET service instead.
...
**Note 1:** The MSAP-APP_CONFIG_DATA_RX service will be deprecated in a future
release. Use MSAP-MSAP-CONFIG_DATA_ITEM service instead.
...
**Note 1:** The MSAP-MSAP-SCRATCHPAD_TARGET_WRITE service will be deprecated in
a future release. Use MSAP-MSAP-CONFIG_DATA_ITEM_SET service instead.
...
firmware. The MSAP-SCRATCHPAD_STATUS.request frame does not contain any payload.
...
| *ScratchpadStatus*                  | 1        | 0 – 255          | Status of the OTAP scratchpad present in the node: <p> - 255 = New: Bootloader has not yet processed the scratchpad<p> - 0 = Success: Bootloader has processed the scratchpad successfully<p> - 1 = Error: Flash write failure (fatal error, old Flash contents lost) <p> - 2 = Error: Invalid scratchpad header length <p> - 3 = Error: Scratchpad CRC check failed <p> - 4 = Error: Scratchpad contents could not be authenticated <p> - 5 = Error: Scratchpad contents could not be decompressed, or ext flash memory not accessable <p> - 6 = Error: Decompressed data is too large to write to Flash <p> - 7 = Error: Invalid file header <p> - 8 = Error: Internal or External flash driver returned an error <p> - 9 = Error: Bootloader and WM stack failed to process the modem firmware <p> - 10 = Error: Bootloader and WM stack failed to process the modem delta firmware <p> - 11 - 254 = Reserved for internal use <p> - Status is 0 also if there is no scratchpad present in the node
...
### MSAP-CONFIG-DATA-ITEM Service

The MSAP-CONFIG-DATA-ITEM service is used for reading and modifying the
mesh configuration data. New configuration data items can be added only
on sink nodes.

The service replaces the MSAP-APP_CONFIG_DATA_nnn and
MSAP-SCRATCHPAD_TARGET_WRITE services which will be deprecated in a
future release.

The MSAP-CONFIG-DATA-ITEM service includes following primitives:

- MSAP-CONFIG_DATA_ITEM_SET.request
- MSAP-CONFIG_DATA_ITEM_SET.confirm
- MSAP-CONFIG_DATA_ITEM_GET.request
- MSAP-CONFIG_DATA_ITEM_GET.response
- MSAP-CONFIG_DATA_ITEM.indication
- MSAP-CONFIG_DATA_ITEM.response
- MSAP-CONFIG_DATA_ITEM_LIST_ITEMS.request
- MSAP-CONFIG_DATA_ITEM_LIST_ITEMS.response

#### MSAP-CONFIG_DATA_ITEM_SET.request

This command shall set a configuration data item. This primitive is only
supported on sink nodes.

| **Field Name** | **Size** | **Valid Values** | **Description**
|----------------|----------|------------------|----------------
| *Primitive ID* | 1        | 0x29             | Identifier of MSAP-CONFIG_DATA_ITEM_SET.request primitive
| *Frame ID*     | 1        | 0 – 255          | See section [General Frame Format](#General-Frame-Format)
| NPD endpoint   | 2        | 0 – 65535        | Endpoint number
| Payload length | 1        | 0 – 80           | Length of the payload
| Payload        | 1-80     | \-               | Payload

#### MSAP-CONFIG_DATA_ITEM_SET.confirm

The MSAP-CONFIG_DATA_ITEM_SET.confirm issued by the stack as a response to the MSAP-CONFIG_DATA_ITEM_SET.request. Frame fields are described in the table below.

| **Field Name** | **Size** | **Valid Values** | **Description**
|----------------|----------|------------------|----------------
| *Primitive ID* | 1        | 0xA9             | Identifier of MSAP-CONFIG_DATA_ITEM_SET.confirm primitive
| *Frame ID*     | 1        | 0 – 255          | See section [General Frame Format](#General-Frame-Format)
| Result         | 1        | 0,1,2,3,4,5      | The return result of the corresponding MSAP-CONFIG_DATA_ITEM_SET.request. The different values are defined as follows: <p> - 0 = Success <p> - 1 = Failure: Invalid role <p> - 2 = Failure: Invalid endpoint <p> - 3 = Failure: Out of memory <p> - 4 = Failure: Invalid content <p> - 5 = Failure: Feature not supported

#### MSAP-CONFIG_DATA_ITEM_GET.request

This command shall set a configuration data item.

| **Field Name** | **Size** | **Valid Values** | **Description**
|----------------|----------|------------------|----------------
| *Primitive ID* | 1        | 0x30             | Identifier of MSAP-CONFIG_DATA_ITEM_SET.request primitive
| *Frame ID*     | 1        | 0 – 255          | See section [General Frame Format](#General-Frame-Format)
| NPD endpoint   | 2        | 0 – 65535        | Endpoint number

#### MSAP-CONFIG_DATA_ITEM_GET.confirm

The MSAP-CONFIG_DATA_ITEM_GET.confirm issued by the stack as a response to the MSAP-CONFIG_DATA_ITEM_GET.request. Frame fields are described in the table below.

| **Field Name** | **Size** | **Valid Values** | **Description**
|----------------|----------|------------------|----------------
| *Primitive ID* | 1        | 0xB0             | Identifier of MSAP-CONFIG_DATA_ITEM_SET.confirm primitive
| *Frame ID*     | 1        | 0 – 255          | See section [General Frame Format](#General-Frame-Format)
| Result         | 1        | 0,1,2            | The return result of the corresponding MSAP-CONFIG_DATA_ITEM_GET.request. The different values are defined as follows: <p> - 0 = Success <p> - 1 = Failure: Invalid endpoint <p> - 2 = Failure: Feature not supported
| Payload length | 1        | 0 – 80           | Length of the payload
| Payload        | 1-80     | \-               | Payload

#### MSAP-CONFIG_DATA_ITEM.indication

The MSAP-CONFIG_DATA_ITEM.indication is issued by the stack when it receives a new CDD item. Frame fields are described in the table below.

| **Field Name** | **Size** | **Valid Values** | **Description**
|----------------|----------|------------------|----------------
| *Primitive ID* | 1        | 0x31             | Identifier of MSAP-CONFIG_DATA_ITEM_SET.request primitive
| *Frame ID*     | 1        | 0 – 255          | See section [General Frame Format](#General-Frame-Format)
| *IndicationStatus* | 1    | 0 or 1       | - 0 = No other indications queued<p> -  1 = More indications queued
| NPD endpoint   | 2        | 0 – 65535        | Endpoint number
| Payload length | 1        | 0 – 80           | Length of the payload
...
#### MSAP-CONFIG_DATA_ITEM.response
 ...
 The MSAP-CONFIG_DATA_ITEM.response is issued by the stack as a response to the MSAP-CONFIG_DATA_ITEM.indication.

#### MSAP-CONFIG_DATA_LIST_ITEMS.request

This command shall request the list of optional CDC items.

| **Field Name** | **Size** | **Valid Values** | **Description**
|----------------|----------|------------------|----------------
| *Primitive ID* | 1        | 0x32             | Identifier of MSAP-CONFIG_DATA_ITEM_SET.request primitive
| *Frame ID*     | 1        | 0 – 255          | See section [General Frame Format](#General-Frame-Format)
| Command        | 1        | 0                | Reserved for future use

#### MSAP-CONFIG_DATA_LIST_ITEMS.confirm

The MSAP-CONFIG_DATA_LIST_ITEMS.confirm issued by the stack as a response to the MSAP-CONFIG_DATA_LIST_ITEMS.request. Frame fields are described in the table below.

| **Field Name**    | **Size**  | **Valid Values** | **Description**
|-------------------|-----------|------------------|----------------
| *Primitive ID*    | 1         | 0xB2             | Identifier of MSAP-CONFIG_DATA_ITEM_SET.confirm primitive
| *Frame ID*        | 1         | 0 – 255          | See section [General Frame Format](#General-Frame-Format)
| Result            | 1         | 0,1              | The return result of the corresponding MSAP-CONFIG_DATA_LIST_ITEMS.request. The different values are defined as follows: <p> - 0 = Success <p> - 1 = Failure: Feature not supported
| Amount endpoints  | 1         | 0 – 16           | Amount of endpoints in the list
| Endpoints list    | 0-32      | \-               | List of endpoints. Each endpoint is 2 bytes long.
...
| 0x10      | Reserved                                           |
| 0x11      | Reserved                                           |
| 0x12      | DECT_TS_103_874_2   DECT NR+ 5G                    |
| 0x13      | Reserved                                           |
| 0x14      | Reserved                                           |
| 0x15      | Reserved                                           |
