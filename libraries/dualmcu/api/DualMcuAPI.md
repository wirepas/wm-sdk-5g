...
| *Frame ID*     | 1        | 0 – 255          | See section [General Frame Format](#General-Frame-Format)
| Result         | 1        | 0,1,2,3,4        | The return result of the corresponding MSAP-CONFIG_DATA_ITEM_SET.request. The different values are defined as follows: <p> - 0 = Success <p> - 1 = Failure: Invalid role <p> - 2 = Failure: Invalid endpoint <p> - 3 = Failure: Out of memory <p> - 4 = Failure: Invalid content
...
| *Frame ID*     | 1        | 0 – 255          | See section [General Frame Format](#General-Frame-Format)
| Result         | 1        | 0,1              | The return result of the corresponding MSAP-CONFIG_DATA_ITEM_SET.request. The different values are defined as follows: <p> - 0 = Success <p> - 1 = Failure: Invalid endpoint
| Payload length | 1        | 0 – 80           | Length of the payload
| Payload        | 1-80     | \-               | Payload
...
| *Frame ID*        | 1         | 0 – 255          | See section [General Frame Format](#General-Frame-Format)
| Result            | 1         | 0                | The return result of the corresponding MSAP-CONFIG_DATA_LIST_ITEMS.request.
