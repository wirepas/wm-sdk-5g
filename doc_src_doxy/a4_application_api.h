...
<tr><td>@ref wms_advertiser.h</td><td>[lib_advertiser](@ref app_lib_advertiser_t)
...
<tr><td>@ref wms_beacon_rx.h</td><td>[lib_beacon_rx](@ref app_lib_beacon_rx_t)</td>
<td>Application library for Bluetooth LE beacon RX</td></tr>
<tr><td>@ref wms_beacon_tx.h</td><td>[lib_beacon_tx](@ref app_lib_beacon_tx_t)</td>
<td>Transmission of Bluetooth LE compatible beacons</td></tr>
<tr><td>@ref wms_data.h</td><td>[lib_data](@ref app_lib_data_t)</td><td>Sending and
receiving data packets</td></tr>
<tr><td>@ref wms_hardware.h</td><td>[lib_hw](@ref app_lib_hardware_t)</td><td>Sharing
of hardware peripherals between stack and application</td></tr>
<tr><td>@ref wms_joining.h</td><td>[lib_joining](@ref app_lib_joining_t)</td><td>Wirepas
Open Joining protocol</td></tr>
<tr><td>@ref wms_memory_area.h</td><td>[lib_memory_area](@ref app_lib_memory_area_t)
</td><td>Access to non-volatile memory areas</td></tr>
<tr><td>@ref wms_otap.h</td><td>[lib_otap](@ref app_lib_otap_t)</td><td>The
Over-The-Air-Programming (OTAP) library</td></tr>
<tr><td>@ref wms_radio_config.h</td><td>[lib_radio_config](@ref app_lib_radio_cfg_t)</td>
<td>Application library for radio power and front end module control</td></tr>
<tr><td>@ref wms_secure_storage.h</td><td>[lib_secure_storage](@ref app_lib_secure_storage_t)</td><td>
Store parameters securely in non-volatile memory</td></tr>
<tr><td>@ref wms_settings.h</td><td>[lib_settings](@ref app_lib_settings_t)</td><td>
Access to node settings, which are stored in nonvolatile memory</td></tr>
<tr><td>@ref wms_sleep.h</td><td>[lib_sleep](@ref app_lib_sleep_t)</td><td>Sleep
Wirepas Mesh stack for time periods</td></tr>
<tr><td>@ref wms_state.h</td><td>[lib_state](@ref app_lib_state_t)</td><td>Viewing
and controlling stack runtime state</td></tr>
<tr><td>@ref wms_storage.h</td><td>[lib_storage](@ref app_lib_storage_t)</td><td>
Small Non-volatile storage area to use for application</td></tr>
<tr><td>@ref wms_system.h</td><td>[lib_system](@ref app_lib_system_t)</td><td>
Low-level functions such as application scheduling, interrupt handling, critical
sections and power management</td></tr>
<tr><td>@ref wms_time.h</td><td>[lib_time](@ref app_lib_time_t)</td><td>Keeping track
...
2. *Emulate the old library*: If the new firmware has the library, but it has an
 incompatible API and application calls <code>[openLibrary()](@ref app_open_library_f)</code> with an old version number. Then, stack returns an
...
They are located in [libraries](@ref libraries) folder.
...
(see [here](@ref app_target_boards) for how to enable application to use specific
board).
...
[These folders](@ref mcu) contain mcu specific files to ease and factorize
...
located in [util](@ref util) folder.

<table>
<tr><th>Name</th><th>Description</th></tr>
<tr><td>@ref api.h "api.h"</td><td>Global API for [Wirepas library services](@ref stack_libraries)</td></tr>
