 ...
 * \brief   This file provides example for persistent storage of provisioning
...
#elif defined(NRF54_PLATFORM) || defined(NRF91_PLATFORM)
    *uid = (uint8_t *)&NRF_FICR->INFO.DEVICEID[0];
