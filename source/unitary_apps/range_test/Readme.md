...
Scan interval can be configured thanks to the application configuration data `A6`. Send one byte representing the seconds to wait between two scans, minimum value of 15 seconds. Application configuration documentation is [here](../../libraries/shared_appconfig/shared_appconfig.md), ex: `f67e01a6011E`  for 30 seconds
