...
class Memory(object):
    ...
    def __iter__(self):
        ...
        # TODO: Iterator
        raise NotImplementedError("iterator not implemented")
...
def save_file(memory, filespec):
    ...
    if file_is_hex:
        ...
        save_binary(memory, filename = filename, start_address = start_address,
                    end_address = end_address, discard_ok = True)
...
def main():
    ...
    try:
        ...
        memory = Memory(overlap_ok = False, gap_fill_byte = fill_byte)
