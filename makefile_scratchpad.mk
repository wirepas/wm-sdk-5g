...
# Extract area IDs from configuration file
STACK_AREA_ID := $(shell $(BOOT_CONF) -i $(config_ini) -sa)
APP_AREA_ID := $(shell $(BOOT_CONF) -i $(config_ini) -aa)
...
ifneq ($(radio),none)
ifneq ($(modem_fw),)
MODEM_FW_FULL_PATH := $(BUILDPREFIX_STACK)$(modem_fw)
...
$(FULL_SCRATCHPAD_WITH_MODEMFW_BIN):
	$(call BUILD_FULL_SCRATCHPAD_WITH_MODEMFW,$(FULL_SCRATCHPAD_WITH_MODEMFW_BIN),$(MODEM_FW_FULL_PATH),$(stack_hex),$(APP_HEX))

$(STACK_SCRATCHPAD_WITH_MODEMFW_BIN):
	$(call BUILD_STACK_SCRATCHPAD_WITH_MODEMFW,$(STACK_SCRATCHPAD_WITH_MODEMFW_BIN),$(MODEM_FW_FULL_PATH),$(stack_hex))
endif
endif
